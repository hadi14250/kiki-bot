...
def	extractInstaPostData(type):
	input = "<meta name='description' content='975K likes, 3,372 comments - memezar on November 6, 2023: &quot;Seeing your reflection on your tire is crazy ud83dude33 Like this content? Follow us for more @memezar...&quot; '><meta property='og:site_name' content='Instagram'>"
	try:
		if (type == "userName"):
			return (extractInstagramUsername(input))
		elif (type == "likeCount"):
			return (extractInstagramLikeCount(input))
		elif (type == "content"):
			return (extractInstagramContent(input))
		elif (type == "postDate"):
			return (extractInstagramDate(input))
	except:
		return (None)

print("username: {}".format(extractInstaPostData("userName")))
print("likes: {}".format(extractInstaPostData("likeCount")))
print("content: {}".format(extractInstaPostData("content")))
print("postDate: {}".format(extractInstaPostData("postDate")))